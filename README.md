...
├── number-guess.html        # Number Guessing Game
│
├── styles.css               # Global styles
├── script.js                # Dashboard scripts
│
├── login-style.css          # Login page styles
├── login-script.js          # Login page logic
│
├── memory-style.css         # Memory game styles
├── memory-script.js         # Memory game logic
│
├── number-guess-style.css   # Number guessing styles
